...
const RelatedVideos = (content) => {
    ...
    return (
        <Link to={`/watch?v=${videoId}`}>
          <div className="flex items-center px-3 w-full rounded overflow-hidden shadow-md border border-gray-200 bg-white hover:shadow-lg transition-shadow duration-300 m-2">
              <img
